...
import { ArrowLeft, MapPinned, FolderHeart, Pill, Layers, ListChecks, ClipboardCheck, FileCode2 } from 'lucide-react'
...
const SECOES = [
  ...
  { to: '/painel/geradores', label: 'Geradores', icone: FileCode2 },
