    ...
    <div className="flex flex-col gap-6 h-full min-h-0">
      <div className="shrink-0">
        <span className="ed-eyebrow">
          <span className="ed-eyebrow-dot" style={{ background: 'var(--tint-lime-fg,#5c9b13)' }} />
          Conteúdo / Complementos
        </span>
        <h1 className="font-display text-[34px] leading-[.98] tracking-[-1.5px] mt-3 mb-2 text-text">
          Peças pequenas que completam a experiência.
        </h1>
        <p className="text-text-dim text-base leading-relaxed max-w-lg">
          Suporte sintomático cadastrado uma vez e vinculado a várias patologias — em Patologias →
