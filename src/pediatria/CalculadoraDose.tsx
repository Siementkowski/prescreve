...
/** Calculadora de dose por peso — filtra os medicamentos que têm dado pediátrico
 *  cadastrado (ped_mg_kg_dia). Se a lista vier vazia mesmo com peso preenchido, o
 *  problema quase sempre é cadastro faltando em Painel → Medicamentos, não a conta em
 *  si (core/pediatria.ts é só peso × mg/kg/dia, sem lógica escondida). */
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {!pesoKg || pesoKg <= 0 ? (
          ...
          <p className="text-sm text-text-dim px-1 py-4">
            Nenhum medicamento com dados pediátricos cadastrados ainda — quem preenche é o
            editor, em Painel → Medicamentos → seção Pediatria (mg/kg/dia, dose máxima,
            concentração).
          </p>
        ) : filtrados.length === 0 ? (
