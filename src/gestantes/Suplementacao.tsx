...
/** Suplementação de rotina no pré-natal — Ácido Fólico, Ferro, AAS e Vitaminas B12/D. Usa
 *  a IG calculada em Pré-natal (store compartilhada — ver gestantes/store.ts), então quem
 *  já calculou lá não precisa informar a DUM de novo aqui. Regra puramente da semana +
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-3xl mx-auto flex flex-col gap-4 pb-16">
        ...
        <div className="border border-border rounded-xl bg-surface p-4 flex flex-col gap-3">
          <p className="text-sm font-semibold text-text">Fatores de risco</p>
